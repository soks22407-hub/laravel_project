...
<head>
    ...
    <link rel="stylesheet" href="{{asset('back_end/assets/libs/jsvectormap/css/jsvectormap.min.css')}}">
...
<body>
            ...
            <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
                ...
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                    ...
                    <li class="dropdown">
                        ...
                        <img src="{{asset('back_end/assets/images/flags/us_flag.jpg')}}" alt="" class="thumb-sm rounded-circle">
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><img src="{{asset('back_end/assets/images/flags/us_flag.jpg')}}" alt="" height="15" class="me-2">English</a>
                            <a class="dropdown-item" href="#"><img src="{{asset('back_end/assets/images/flags/spain_flag.jpg')}}" alt="" height="15" class="me-2">Spanish</a>
                            <a class="dropdown-item" href="#"><img src="{{asset('back_end/assets/images/flags/germany_flag.jpg')}}" alt="" height="15" class="me-2">German</a>
                            <a class="dropdown-item" href="#"><img src="{{asset('back_end/assets/images/flags/french_flag.jpg')}}" alt="" height="15" class="me-2">French</a>
                        </div>
                    ...
                    <li class="dropdown topbar-item">
                        <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                            aria-haspopup="false" aria-expanded="false">
                            <img src="{{asset('back_end/assets/images/users/avatar-1.jpg')}}" alt="" class="thumb-lg rounded-circle">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end py-0">
                            <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                                <div class="flex-shrink-0">
                                    <img src="{{asset('back_end/assets/images/users/avatar-1.jpg')}}" alt="" class="thumb-md rounded-circle">
                                </div>
    ...
    <div class="startbar d-print-none">
        ...
        <div class="brand">
            <a href="index.html" class="logo">
                <span>
                    <img src="{{asset('back_end/assets/images/logo-sm.png')}}" alt="logo-small" class="logo-sm">
                </span>
                <span class="">
                    <img src="{{asset('back_end/assets/images/logo-light.png')}}" alt="logo-large" class="logo-lg logo-light">
                    <img src="{{asset('back_end/assets/images/logo-dark.png')}}" alt="logo-large" class="logo-lg logo-dark">
                </span>
            </a>
        </div>
        <!--end brand-->
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarUsermanagement">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('site_setting.index') }}">Site Settings</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
    ...
    <script src="{{asset('back_end/assets/libs/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('back_end/assets/libs/simplebar/simplebar.min.js')}}"></script>

    <script src="{{asset('back_end/assets/libs/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('back_end/assets/data/stock-prices.js')}}"></script>
    <script src="{{asset('back_end/assets/libs/jsvectormap/js/jsvectormap.min.js')}}"></script>
    <script src="{{asset('back_end/assets/libs/jsvectormap/maps/world.js')}}"></script>
    <script src="{{asset('back_end/assets/js/pages/index.init.js')}}"></script>
