                            ...
                            <div class="col-auto"> 
                                <form class="row g-2">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a class="btn btn-primary" href="{{route('role.create')}}"><i class="fa-solid fa-plus me-1"></i>Add Role</a>
                                    </div><!--end col-->
                                </form>    
                            </div><!--end col-->
                        </div><!--end row-->                                  
                                    ...
                                    @php($i=1)
                                        @foreach ($rows as $row)
                                            <tr>          
                                                ...
                                                <td class="text-end">                                                       
                                                    <a href="{{route('role.update', $row->id)}}"><i class="las la-pen text-secondary fs-18"></i></a>
