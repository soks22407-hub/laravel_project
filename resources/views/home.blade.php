                        ...
                        <div class="col-auto align-self-center">
                            <div class="img-group d-flex">
                                <a class="user-avatar position-relative d-inline-block" href="#">
                                    <img src="{{asset('back_end/assets/images/users/avatar-1.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                </a>
                                <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                    <img src="{{asset('back_end/assets/images/users/avatar-2.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                </a>
                                <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                    <img src="{{asset('back_end/assets/images/users/avatar-4.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                </a>
                                <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                    <img src="{{asset('back_end/assets/images/users/avatar-3.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                </a>
                ...
                <div class="card-body pt-0">
                    <div class="table-responsive browser_users">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{asset('back_end/assets/images/logos/chrome.png')}}" alt height="24" class="me-2">Chrome</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><img src="{{asset('back_end/assets/images/logos/micro-edge.png')}}" alt height="24" class="me-2">Microsoft
                                        Edge</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><img src="{{asset('back_end/assets/images/logos/in-explorer.png')}}" alt height="24" class="me-2">Internet-Explorer</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><img src="{{asset('back_end/assets/images/logos/opera.png')}}" alt height="24" class="me-2">Opera</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 align-self-center">
                            <div class="d-flex align-items-center my-3">
                                <img src="{{asset('back_end/assets/images/flags/us_flag.jpg')}}" class="thumb-sm align-self-center rounded-circle" alt="...">
                            ...
                            <!--end media-->
                            <div class="d-flex align-items-center my-3">
                                <img src="{{asset('back_end/assets/images/flags/germany_flag.jpg')}}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                <div class="flex-grow-1 ms-2">
                            ...
                            <!--end media-->
                            <div class="d-flex align-items-center my-3">
                                <img src="{{asset('back_end/assets/images/flags/spain_flag.jpg')}}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                <div class="flex-grow-1 ms-2">
                            ...
                            <!--end media-->
                            <div class="d-flex align-items-center my-3">
                                <img src="{{asset('back_end/assets/images/flags/baha_flag.jpg')}}" class="thumb-sm align-self-center rounded-circle" alt="...">
                                <div class="flex-grow-1 ms-2">
